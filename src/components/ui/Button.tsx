'use client';
  ...
  export type ButtonVariant = 'primary' | 'secondary' | 'success' | 'danger' | 'ghost' | 'purple';
   ...
   * <Button variant="danger" loading>Carregando...</Button>
   */
  export default function Button({
    ...
    const variantClasses: Record<ButtonVariant, string> = {
      ...
      purple: 'bg-purple-600 text-white hover:bg-purple-700 focus:ring-purple-500 disabled:bg-gray-400',
    };
